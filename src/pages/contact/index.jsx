...
function Contact() {
  ...
  const handleChange = (e) => {
    ...
    if (name === "name") {
      ...
      errorEmail = !ValidationEmail(value);
    }

    let isButtonEnable =
      ValidationEmail(state.email) && !errorName && !errorMessage;

    setState({
      ...state,
      [name]: value,
      // errorEmailMessage: !ValidationEmail(state.email),
  ...
  const validationEmailFocus =(e)=>{
    // alert(validationComment(e.target.value))
              ...
              <div className="flex flex-wrap justify-center">
                ...
                <div className=" basis-full mt-[20px]">
                  <p className=" text-center">
                    <span className="text-teal-300 text-center text-lg">
                      OR
                    </span>
                  </p>
